...
userSchema.methods.canAccessData = function(dataType, dataId) {
  ...
  switch (dataType) {
    case 'project':
      return Array.isArray(this.dataScope.projects) && this.dataScope.projects.includes(dataId);
    case 'module':
      return Array.isArray(this.dataScope.modules) && this.dataScope.modules.includes(dataId);
    case 'partner':
      return Array.isArray(this.dataScope.partners) && this.dataScope.partners.includes(dataId);
    default:
      return false;
  }
};
